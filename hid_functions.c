...
// Report count = number of bytes
// Report size = number of bits
...
const struct usb_endpoint_descriptor hid_endpoint = {
	...
	.bEndpointAddress = EP_ADDRESS_IN_1,
...
const char * usb_strings[] = {
    "TEST_MANUFACTURER", // iManufacturer (1)
    "TEST_PRODUCT", // iProduct (2)
    "TEST_SERIAL" //iSerial (3)
};
			...
			void (**complete)(usbd_device *, struct usb_setup_data *))
{
	...
	*buf = (uint8_t *)&hid_report_descriptor[0];
	*len = sizeof(hid_report_descriptor) / sizeof(uint8_t);
